...
import {
    ...
    signUpUser,
    userData,
} from '../../../../redux/loginState/LoginSlice'

// NOTE:login button of Sign up component-------------------------
...
function SignUp({ setShowUi }: { setShowUi: (string: string) => any }) {
